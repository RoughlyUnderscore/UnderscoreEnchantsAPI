...
#### If you would like to see the implementation of this API in UnderscoreEnchants, click [here](https://github.com/RoughlyUnderscore/UnderscoreEnchantsCode/blob/master/src/main/java/com/roughlyunderscore/enchs/UnderscoreEnchants.java#L409).
